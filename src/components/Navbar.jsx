...
const Navbar = () => {
  return (
    <div className=" absolute w-[450px] h-[80px] flex flex-row items-center justify-evenly gap-2 md:gap-4 text-white font-bold bg-[#282829] border-[0.5px]  border-[#787676] rounded-tr-[20px] rounded-bl-[20px] mt-[20px] ml-[766px]">
